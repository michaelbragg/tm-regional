...
<div id="<?php the_slug() ?>">
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <section class="box-gradient cf">
            <?php $tablepress_options = json_decode( get_option( 'tablepress_tables' ) );
			foreach ( the_tables() as $table ) :   tablepress_print_table( 'id=' . get_tablepress_id( $tablepress_options, $table ) . '&use_datatables=false&print_name=false' ); endforeach; }?>
        </section>
        <!-- .container -->
