...
<?php /* Check to see if there content */ ?>
		...
		if ( has_blocks() ) : ?>
			...
			for ( $i = 0; $i < count( $blocks ); ++$i ) {
				printf( '<div class="%1$s"><div class="title-item"><h3>%2$s</h3><p>%3$s</p></div></div>', class_blocks( 'col-md-12 white', 'col-md-6 white', 'col-md-4 white' ), $blocks[ $i ]['heading'], $blocks[ $i ]['text'] );
			} ?>
			</div>
		<?php endif; ?>
